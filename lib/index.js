	...
	(0, _createClass3.default)(ImagesUploader, [{
		...
		value: function deleteImage(key, url) {
			if (!this.props.disabled) {
				...
				var g = _imagePreviewUrls.splice(key, 1);
				this.setState({
		...
		value: function () {
			var _ref = (0, _asyncToGenerator3.default)( /*#__PURE__*/_regenerator2.default.mark(function _callee(files, url, onLoadEnd) {
				var imageFormData, tstArray, i, multiple, _imagePreviewUrls2;
						...
						switch (_context.prev = _context.next) {
							case 0:
								try {
									...
									_imagePreviewUrls2 = this.state.imagePreviewUrls.concat(tstArray);
